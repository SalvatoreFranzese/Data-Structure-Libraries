...
class BinaryTree : virtual public BreadthMappableContainer<Data>, virtual public BreadthFoldableContainer<Data>,
                   virtual public InOrderMappableContainer<Data>, virtual public InOrderFoldableContainer<Data> {
...
public:
  ...
  public:
    ...
    virtual inline bool IsLeaf() const noexcept = 0;
...
protected:
  ...
  typename BinaryTree<Data>::Node* currNode = nullptr; // Pointer to the current node
...
public:
  ...
  typename BinaryTree<Data>::Node* getLeftMostLeaf(typename BinaryTree<Data>::Node*);
...
public:
  ...
  typename BinaryTree<Data>::Node* getLeftMostNode(typename BinaryTree<Data>::Node*);
